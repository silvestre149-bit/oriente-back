    ...
    static async adicionarParticipacao(id, participacoes) {
        ...
        return Promise
            ...
            .then(([semestre, usuario, participacoesObj]) => {
                ...
                console.log(participacoesCadastradas);
    ...
    static async removerParticipacao(id, participacoes) {
        ...
        return Promise
            ...
            .then(([usuario, participacoesObj]) => {
                ...
                return usuarioService.atualizar(id, { participacoes: novasParticipacoes })
            })
            .then(usuario => {
                console.log(usuario)
                return participacaoService.deletar(participacoes)
            })
    }
